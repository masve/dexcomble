...
public class CRC16 {
    ...
    public static final String TAG = "CRC16";

    /**
     * Compute the CRC16 of the byte array and append.
     *
     * @param a the byte array
     * @return byte array with crc bytes appended.
     */
    public static byte[] get2(byte[] a) {
        byte[] crc = get3(a);
        byte[] crcAppended = new byte[a.length+crc.length];
        for (int i = 0; i < a.length; i++) {
            crcAppended[i] = a[i];
        }

        crcAppended[a.length] = crc[0];
        crcAppended[a.length+1] = crc[1];
...
//    }
    ...
    private static byte[] get3(byte[] bytes) {
